    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orders', models.ManyToManyField(blank=True, related_name='bottles', to='client.order', verbose_name='Orders')),
            ],
        ),
        migrations.CreateModel(
            name='BottleCount',
            fields=[
                ...
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bottle_count', to='client.order')),
            ],
        ),
    ]
